...
class LoadNanopoolShareCoefficientUseCase @Inject constructor(
    dispatchers: AppCoroutineDispatchers,
    private val accountRepository: AccountRepository
) : UseCase<LoadNanopoolShareCoefficientUseCase.Params, NanopoolPoolInfo>() {

    override val dispatcher = dispatchers.io

    override suspend fun doWork(params: Params): NanopoolPoolInfo {
        return accountRepository.loadNanopoolShareCoefficient(
