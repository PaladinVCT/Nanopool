...
class LoadAverageWorkerChartDataUseCase @Inject constructor(
    dispatchers: AppCoroutineDispatchers,
    private val accountRepository: AccountRepository
) : UseCase<LoadAverageWorkerChartDataUseCase.Params, ChartData>() {

    override val dispatcher = dispatchers.io

    override suspend fun doWork(params: Params): ChartData {
        return accountRepository.loadWorkerChartData(
